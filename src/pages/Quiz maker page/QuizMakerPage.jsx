...
export default function QuizMakerPage() {
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      <NavBar />
      <div className="hero h-full flex flex-wrap gap-4 relative w-full overflow-hidden">
        ...
        <div className="quizCardContainer overflow-y-auto h-full flex-1 w-full">
          {questions.length != 0 ? (
            ...
            <div className="h-full w-full flex flex-col justify-center items-center gap-4">
              <div className="heading md:text-7xl text-5xl font-black">No Questions</div>
              <div className="text-center max-w-[60vw]"><FaHandPointLeft className="inline mr-4 -mt-1" size="1.5rem" />Try adding some questions from the sliding menu on the left.</div>
            </div>
          )}
        </div>
      </div>
