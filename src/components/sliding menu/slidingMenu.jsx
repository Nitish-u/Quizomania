...
export default function SlidingMenu({ isOpen }) {
  return (
    <div className={`menuContainer w-fit p-4 rounded-3xl text-center flex flex-col items-center gap-2 customShadowForQuizCard absolute z-10 left-12 top-24 max-h-full -translate-x-80 bg-white ${isOpen ? "translate-x-0" : ""} transition-transform duration-500`}>
      <div className="profilePic p-4 rounded-full profilePicShadow">
        <img src={profilePic} alt="profile pic" className="w-24 cursor-pointer" />
      </div>
